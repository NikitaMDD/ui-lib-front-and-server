...
const EmployeeLoginPageView = () => import('../components/views/EmployeeLoginPage.vue');
...
export const routes = [
    ...
    { path: '/employee-login', name: 'EmployeeLogin', clientName: 'Страница входа для сотрудников', component: EmployeeLoginPageView },
]
